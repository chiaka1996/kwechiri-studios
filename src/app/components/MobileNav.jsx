...
const MobileNavigationBar = () => {
    ...
    return(
        ...
        <nav className="tracking-[3%] leading-[150%] md:max-w-[1248px] mx-auto h-[48px] md:h-[88px] flex justify-between items-center md:px-[32px]  border border-l-0 md:border-l-[6px] border-t-0 border-r-[0] border-b-[0] border-l-[#E36A02]">
            ...
            <ul className="text-[20px] text-[#354764] tracking-[2%] space-y-[40px] py-[40px] w-full ">
                <li><Link href="/"  onClick={toggleMobileNavbarFunction}>Home</Link></li>
                <li> <Link href="/#about"  onClick={toggleMobileNavbarFunction}>About</Link></li>
                <li> <Link href="/#service" onClick={toggleMobileNavbarFunction} >Services</Link></li>
                <li> <Link href="/#projects"  onClick={toggleMobileNavbarFunction}>Our Work</Link></li>
                <Link href="/#contact" onClick={toggleMobileNavbarFunction}>
